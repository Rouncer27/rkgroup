  ...
  const { site, siteLogo, defaultFb } = useStaticQuery(
    graphql`
      query {
        ...
        siteLogo: file(relativePath: { eq: "rk-group-main-logo.png" }) {
          publicURL
        }

        defaultFb: file(
          relativePath: { eq: "social-share-image-home-page.png" }
        ) {
          publicURL
        }
      }
  ...
  return (
    <React.Fragment>
      ...
      <SchemaOrg
        ...
        canonicalUrl="https://example.ca/"
        author=""
        organization="RK Group"
        defaultTitle="RK Group"
      />
    </React.Fragment>
  )
}
